...
export const ScanBarCodeWrapper = styled.div<{ hide?: boolean }>`
  ...
  *:after {
  ...
  .dropzone {
    ...
    --dropzone-body-color: var(--text-muted);
  ...
  .dropzone::part(dropzone):focus-visible {
    box-shadow: 0 0 0 2px var(--focus);
  }
  ...
  @supports (color: rgb(from white r g b)) {
    @media (hover: hover) {
      a-tab:not([selected])::part(base):hover {
        background-color: rgb(from var(--accent) r g b / 0.06);
      }
    }
  }
