                    ...
                    let V,
                      ...
                      Y = async () => {
                        ...
                        try {
                          ...
                          e && ([u, _] = JSON.parse(await W(e)));
                        } catch (e) {}
                        try {
                          null == u &&
                            ((u = H()), x.setItem(C, await z(JSON.stringify([u, null]))));
                        } catch (e) {}
                        V.resolve();
                      },
                      q = async () => {
                      ...
                      Q = async (e) => {
                        ...
                        try {
                          ...
                          w && (t.rmk = w),
                            s && (-1 != s.indexOf("-") ? (t.hs = s) : (t.og = s));
                          let n = {};
                          if (_) {
                            let e = await x.getItem(C);
                            e && ([u, _] = JSON.parse(await W(e))), (n["lts-time"] = _);
                          }
                          v && (t.sp = v);
                          let d = await Promise.race([
                            (async () => {
                              ...
                              _ && (x.setItem(C, await z(JSON.stringify([u, o]))), (_ = o));
                          ...
                          try {
                            ...
                            for (let e = 0; e < r.length / 1e3; ++e) {
                              ...
                              for (let e = 0; e < t.length; ++e)
                                n.push(await M.getItem(t[e]));
                              _ = new Date().kUtilFormat("yyyy-MM-ddTHH:mm:ss.SSSZ");
                              {
                                let e = await x.getItem(C);
                                e && ([u] = JSON.parse(await W(e))),
                                  x.setItem(C, await z(JSON.stringify([u, _])));
                              }
                              try {
                                let e,
                                  r,
                    ...
                    return {
                      i: async (e) => {
                        (r = e.pd),
                          ...
                          e.dt && (c = e.dt),
                          (s = e.l || ""),
                          (l = "string" != typeof e.os ? JSON.stringify(e.os) : e.os),
                          (f = e.fn),
                ...
                let ue = new n(),
                  ...
                  fe = async (e) => {
                    await ue,
                      (ee = e.trial),
                      (te = e.msg),
                      Module[ie].init(JSON.stringify(e));
                  },
                  me = () => {
                    ...
                    switch (
                      ...
                      case "loadWasm":
                        try {
                          ...
                          let o,
                            a = r.bptk;
                          (async () => {
                            if (le) throw "can't load wasm twice";
                            (le = !0), ve("wasm loading...");
                            let e = Date.now();
                      ...
                      case "createInstance": {
                        ...
                        try {
                          ...
                          r.bScanner
                            ? ((n.expectedBarcodesCount = 1),
                              (n.deblurLevel = 0),
                              (n.localizationModes = [16, 2, 0, 0, 0, 0, 0, 0]))
                      ...
                      case "decodeBuffer": {
                        ...
                        try {
                          (e = X ? Date.now() : 0),
                            (d = a.buffer),
                            (u = a.stride * a.height) > ce &&
                              (de && Module._free(de), (de = Module._malloc(u)), (ce = u)),
                            Module.HEAPU8.set(d.subarray(0, u), de),
                            (t = X ? Date.now() : 0),
                            (s = JSON.parse(
                              ge
                                .get(o)
                      ...
                      case "getIntermediateResults": {
                        let e = [];
                        try {
                          var s = ge.get(o).getIntermediateResults(a.isCharge),
                            i = JSON.parse(s, (t, r) => {
